...
namespace Kaudaj\Module\ContentBlocks\Grid\Position;

use Kaudaj\Module\ContentBlocks\Grid\Position\UpdateHandler\ContentBlockPositionUpdateHandler;
use PrestaShop\PrestaShop\Core\Grid\Position\GridPositionUpdaterInterface;
use PrestaShop\PrestaShop\Core\Grid\Position\PositionUpdateInterface;

final class ContentBlockGridPositionUpdater implements GridPositionUpdaterInterface
{
    /**
     * @var ContentBlockPositionUpdateHandler
     */
    private $updateHandler;

    public function __construct(ContentBlockPositionUpdateHandler $updateHandler)
    {
