...
final class ContentBlockGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    use DeleteActionTrait;

    public const GRID_ID = 'content_blocks';
    ...
    {
        return $this->trans('Content blocks', [], 'Modules.Kjcontentblocks.Admin');
    }
    ...
    protected function getColumns()
    {
        ...
        if ($this->hookId !== null) {
            $positionColumn = (new PositionColumn('position'))
                ...
                ->setOptions([
                    'id_field' => 'id_content_block',
                    'position_field' => 'position',
                    'update_method' => 'POST',
                    'update_route' => 'kj_content_blocks_content_blocks_update_position',
                ])
            ;
    ...
    private function getRowActions(): RowActionCollectionInterface
    {
        return (new RowActionCollection())
            ->add((new LinkRowAction('edit'))
                ...
                ->setIcon('edit')
                ->setOptions($this->getRouteOptions('kj_content_blocks_content_blocks_edit') + [
                    'clickable_row' => true,
                ])
            )
            ->add(
                $this->buildDeleteAction(
                    'kj_content_blocks_content_blocks_delete',
                    'contentBlockId',
                    'id_content_block',
    ...
    protected function getFilters()
    {
        $filters = (new FilterCollection())
            ->add((new Filter('id_content_block', TextType::class))
                ->setTypeOptions([
                    'required' => false,
                    'attr' => [
                ...
                ->setAssociatedColumn('id_content_block')
            )
            ...
            ->add((new Filter('actions', SearchAndResetType::class))
                ->setTypeOptions([
                    ...
                    'redirect_route' => 'kj_content_blocks_content_blocks_index',
                ])
